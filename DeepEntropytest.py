...
from entropy import calculate_entropy,probility_entropy_weight1,any_probility_entropy_weight,DeepEntropy
...
if __name__ == '__main__':
    ...
    for num in range(100, 1100, 100):
        ...
        for i in range(1, 11):
            ...
            # 计算每个测试用例的熵
                entropies = np.array([DeepEntropy(a,b,prob) for prob in predicted_probabilities])
        ...
        print("检索数：" + str(num) + "权重：" + str(a) + ":" + str(b))
