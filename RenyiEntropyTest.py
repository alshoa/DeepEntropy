...
from ATStest.ATS import ATS
from utils import model_conf
import numpy as np
from utils.utils import num_to_str, shuffle_data, shuffle_data3
from entropy import renyi_entropy,any_renyi_entropy
...
def fault_detection(y, y_psedu):
    ...
    #print("发现错误类型数: {}/{}".format(diverse_fault_num, 90))
...
if __name__ == '__main__':
    ...
    for num in range(100, 1100, 100):
        ...
        for i in range(1, 11):
            ...
            # 计算每个测试用例的熵
            entropies = np.array([any_renyi_entropy(2,prob) for prob in predicted_probabilities])
        ...
        print("检索前" + str(num) + "个的情况为")
        print("平均发现错误总数" + str(total_mistake / 10))
        print("平均发现错误种类" + str(mistake_type / 10))
