...
if __name__ == '__main__':
    ...
    if data_name =="mnist":
      ...
      if Model_name== "LeNet5":
        index_without_noisy=np.load(r"C:\Users\alshoa\Desktop\DeepEntropy-Prioritizing-Robustness-Testing-of-Deep-Classifiers--main\ATS-master_final\Index_WN\mnist\Inw_mnist_LeNet5.npy")
        model_path = model_conf.get_model_path(model_conf.mnist, model_conf.LeNet5)
      if Model_name=="LeNet1":
        index_without_noisy=np.load(r"C:\Users\alshoa\Desktop\DeepEntropy-Prioritizing-Robustness-Testing-of-Deep-Classifiers--main\ATS-master_final\Index_WN\mnist\Inw_mnist_LeNet1.npy")
    ...
    if data_name =="Cifar10":
      ...
      if Model_name=="12Conv":
        ...
        index_without_noisy=np.load(r"C:\Users\alshoa\Desktop\DeepEntropy-Prioritizing-Robustness-Testing-of-Deep-Classifiers--main\ATS-master_final\Index_WN\cifar10\Inw_cifar10_12Conv.npy")
        model_path = model_conf.get_model_path(model_conf.cifar10, model_conf.Conv12)
      if Model_name=="ResNet20":
        index_without_noisy=np.load(r"C:\Users\alshoa\Desktop\DeepEntropy-Prioritizing-Robustness-Testing-of-Deep-Classifiers--main\ATS-master_final\Index_WN\cifar10\Inw_cifar10_ResNet20.npy")
        model_path = model_conf.get_model_path(model_conf.cifar10, model_conf.ResNet20)
    if data_name=="SVHN":
      train_raw = loadmat(r'C:\Users\alshoa\Desktop\DeepEntropy-Prioritizing-Robustness-Testing-of-Deep-Classifiers--main\Data\train_32x32.mat')
      test_raw = loadmat(r'C:\Users\alshoa\Desktop\DeepEntropy-Prioritizing-Robustness-Testing-of-Deep-Classifiers--main\Data\test_32x32.mat')
      ...
      if Model_name== "LeNet5":
        index_without_noisy=np.load(r"C:\Users\alshoa\Desktop\DeepEntropy-Prioritizing-Robustness-Testing-of-Deep-Classifiers--main\ATS-master_final\Index_WN\SVHN\Inw_SVHN_LeNet5.npy")
    ...
    # load dataset
      ...
      if Model_name== "LeNet4":
        index_without_noisy=np.load(r"C:\Users\alshoa\Desktop\DeepEntropy-Prioritizing-Robustness-Testing-of-Deep-Classifiers--main\ATS-master_final\Index_WN\Fashion_mnist\Inw_Fashion_mnist_LeNet4.npy")
    ...
    # 1000
    print("Select the first 1000 augmented data")
    num = 1000
    # ATS
